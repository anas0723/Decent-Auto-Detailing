...
const Footer = () => {
  ...
  return (
    <footer className="bg-darkblack text-white pt-12 pb-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-skyblue mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">info@decentautodetailing.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-skyblue mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
