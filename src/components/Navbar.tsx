          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white">
                <DropdownMenuItem>
                  <Link to="/services/mobile-detailing" className="w-full">
                    Mobile Detailing
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/services/window-tint" className="w-full">
                    Window Tint
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <Link to="/services/ceramic-coating" className="w-full">
                    Ceramic Coating
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>
              ...
              <div className="relative">
                ...
                {isServicesOpen && (
                  <div className="pl-4 py-2 space-y-2 bg-gray-50">
                    <MobileNavLink to="/services/mobile-detailing" onClick={toggleMenu}>
                      Mobile Detailing
                    </MobileNavLink>
                    <MobileNavLink to="/services/window-tint" onClick={toggleMenu}>
                      Window Tint
                    </MobileNavLink>
                    <MobileNavLink to="/services/ceramic-coating" onClick={toggleMenu}>
                      Ceramic Coating
                    </MobileNavLink>
                  </div>
                )}
